...
| [[パタン/内発的動機付け]]           | 「やらされる」でなく「やりたい」——内側から湧く動機づけ |
...
| [[パタン/熟慮的動機付け]]       | 関心の3意味・真の関心vs偽の関心（糖衣）・目的形成3段階——多方興味との接続（Dewey補強）                    |
...
### 実践省察の考察（そら子の問い, 2026-06-06）

| パタン | 核心 |
| --- | --- |
| [[メタパタン/経験から出発する]] | そら子の問い：経験の出発点は「授業直後に自然に浮かぶ感覚」——3分メモより手前の前言語的余韻・Deweyのundergoeingとの接続・「全部に名前をつけなくていい」という許可 |
| [[パタン/フロネーシス（実践的知恵）]] | そら子の問い：フロネーシスは言語化の前・授業後の感覚的余韻の中に既に宿っている——「あの子の顔が引っかかっている」感覚がそれ。一場面から出発してよい |
...
| [[パタン/内発的動機付け]] | 歓び（Joy）vs 快楽（Pleasure）——内発的動機の質的指標として「創造の証」を使う（ベルクソン接続） |
...
| [[パタン/内発的動機付け]] | 快感原則→現実原則の発達的転換が内発的動機の基盤——「愛の条件性」と動機設計・「分かっても変わらない」の構造（フロイト接続） |
...
| [[パタン/内発的動機付け]] | 「道楽でたいていのことは学べる」——道楽が内発的動機の実践語・「遊びまくった経験が財産」・「俳句は作者そのもの、要は遊べばいい」（北大路翼接続） |
