...
### Fletcher（1996）A Writer's Notebook 統合（2026-06-02）：「テキストから書く（Writing off the Text）」——模倣が師匠になる

Buckner（2005, 2009）が「気づき（Noticings）」を経由して「作家のように読む」を体系化するとすれば、Ralph Fletcher（1996）第10章「Writing off the Text」はその**前身となる実践の原型**を示す。

> 「上手く書こうとするなら、自分の言葉の周りに他者の美しい文章を置かなければならない。」——Fletcher（1996）Ch.10

Fletcherが示すプロセスは「テキストを読む→そのテキストから発想して書く（writing off）」——「模倣（imitation）」を学習の中心に据える：

**Valerie Worthの貝殻の詩からFletcherの球根の詩へ：**
Fletcherは詩人Valerie Worthの貝殻についての詩（*All The Small Poems*）を読み、「これに触発されて球根（bulbs）について書こう」と思った。球根と貝殻は全く違う対象だが、Worthの「小さなものへの細部の観察」という姿勢を模倣した。
→ 「テキストから書く」は「テキストを写す」ことではなく「テキストの精神・構造・姿勢を借りる」こと。

**Stephanie MillerがByrd Baylorを模倣した例：**
Fletcher（Ch.10）でStephanie Millerという生徒が、Byrd Baylor（詩的な散文で知られる作家）の語りのスタイルを借りて書いた。Baylorの「you」（読者への語りかけ）と「specific desert detail（砂漠の具体的な細部）」という二つの要素を模倣した——これが「自分の言葉で書く」基盤になった。

**「模倣は本物の書くことの妨げか？」：**
Fletcherは「模倣（imitation）」を「カンニング」として排除するのではなく、学習の正統なプロセスとして位置づける。すべての書き手は誰かを読んで学ぶ。Julius Lesterが「自分が何をしているか知らない」のと同様に、Valerie Worthも意識しない技法を詩に埋め込んでいる——読者がそれを意識的に抽出し、自分の言葉で試す。

- **既存パタンとの関連**：Buckner（2005）の「気づき（Noticings）」と同じ「読む→観察→真似る」の構造だが、Fletcherは「テキストから書く（writing off）」という一連の実践として位置づけ、模倣の正統性を明確に肯定する
- **補強された点**：「技法に名前をつけて観察する」（Buckner）に加え、「テキスト全体の精神・構造・姿勢を借りて書く」（Fletcher）という、より大きな単位での模倣実践が加わる。「詩のスタイルを借りる」「語りの人称を借りる」など、技法単位でなくテキスト単位での学習が可能になる
- **他のパタンへの波及**：[[パタン/ミメーシス（模倣による学び）]] — Fletcherのwriting off the textはミメーシスの書くことへの具体的応用；[[パタン/書くように生きる]] — 「美しい文章に自分の言葉を囲ませる」という習慣が書くように生きることの日常形態；[[文献/A Writer's Notebook（Fletcher）]] — 本統合の出典
...
flowchart LR
    ...
    ne4bd9ce5aeb6e381aee38288e38186e381abe8aaade38280 --- ne4bc9ae8a9b1e38292e68ea1e99b86e38199e3828b
    ne4bd9ce5aeb6e381aee38288e38186e381abe8aaade38280 --- ne69bb8e3818de3818be38188e381bee381ade381a3e38193efbc88e6aeb5e99a8ee79a84e8b6b3e5a0b4e381aee981b8e68a9ee588b6efbc89
