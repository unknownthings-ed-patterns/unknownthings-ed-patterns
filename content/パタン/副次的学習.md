...
type: pattern
status: complete
tags: [パタン, デューイ, 経験, 学習文化, 動機付け, 副次的学習, アリストテレス, 政治学, エソス, 習慣]
...
### アリストテレス（前335年頃）——政治学 第2巻・エソス（習慣づけ）

> 「教育の力によって、共同体が統一される。」（政治学 第2巻第2章）
...
- **補強された点**：アリストテレスは「法（ノモス）より習慣の方が政体の根本に近い」と言う——制度・ルールより日常の繰り返しが人間を作る。これは副次的学習の設計が「一授業の態度」に留まらず、**年間を通じた習慣の設計**でもあることを示す。
