...
- [[パタン/IRE型応答の脱却（Talk Move）]] — 教師の第3ターンを評価からTalk Moveへ組み替える構造パタン。哲学対話はIRE構造の構造的対極にあり、教師が評価者の座を降りる徹底形
- [[パタン/心の状態言語の意図的使用（メンタル・ステート・トーク）]] — 哲学対話での「信じる/知る/疑う/不思議に思う」は心の状態言語が最も豊富に現れる文脈の一つ（Brandt, 2026）
- [[パタン/ことばの武器化の三段階（スティグマ化・非人間化・ハーム）]] — 哲学対話がことばの権力的使用を批判的に検討する場となる。「この言葉はなぜ力を持っているのか？」という問いがP4Cの素材になる（Pentón Herrera, 2026）
...
flowchart LR
    ...
    ne593b2e5ada6e5afbee8a9b1efbc88503443efbc89 --- n495245e59e8be5bf9ce7ad94e381aee884b1e58db4efbc8854616c6b204d6f7665efbc89
